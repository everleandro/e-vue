...
export const Form = () => ({
  ...
  template: `
  <div class="container"> 
    <p>The internal e-form component makes it easy to add validation to form inputs.
     All input components have a rules prop which accepts a mixed array of types function. These allow you to specify conditions in which the input is valid or invalid.
    ...
    <div class="outlined pa-3 mt-10">
      ...
      <e-form ref="form1" v-model="form1Model">
        <e-text-field v-model="fields.name" label="Name" outlined></e-text-field>
        <e-text-field v-model="fields.lastName" label="Last Name" outlined></e-text-field>
        <e-text-field v-model="fields.email" label="E-mail *" outlined :rules="[required,emailRule]"></e-text-field>
        <e-checkbox v-model="fields.acceptRules" :rules="[checkboxRule]" label="acepto las politicas" ></e-checkbox>
      </e-form>
      <e-radio-group
        v-model="radio"
        row
      ...
      <e-button color="primary" :disabled="!form1Model" @click="validate()">Validate</e-button>
    ...
    <div class="outlined pa-3 mt-24">
      ...
      <e-form ref="form2" v-model="form2Model" :lazy="false">
        ...
        <e-text-field label="Last Name *" :rules="[required]" outlined></e-text-field>
      </e-form>
