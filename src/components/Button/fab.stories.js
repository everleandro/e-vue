      ...
      <e-row>
        <e-col col="24">
          <div class="outlined box">
            ...
            <e-button class="mx-12" icon depressed large color="primary"> <e-icon>mdi mdi-alarm</e-icon></e-button>
            <e-button class="mx-12" icon depressed x-large color="secondary"> <e-icon>mdi mdi-alarm</e-icon></e-button>
          </div>
        </e-col>
      </e-row>
    </div> `,
